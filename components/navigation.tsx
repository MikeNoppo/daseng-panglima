        ...
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center gap-2">
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-300 ${
                shouldBeTransparent ? "bg-white/20" : "bg-primary/20"
              }`}
            >
              <span
          ...
          <button
            ...
            className={`md:hidden p-2 rounded-lg transition-colors duration-300 ${
              shouldBeTransparent ? "hover:bg-white/20 text-white" : "hover:bg-muted text-foreground"
            }`}
          >
        ...
        {isOpen && (
          <div
            className={`md:hidden pb-4 space-y-2 transition-colors duration-300 ${
              shouldBeTransparent ? "bg-black/20" : "bg-background/95"
            }`}
          >
            {navItems.map((item) => (
              <Link
